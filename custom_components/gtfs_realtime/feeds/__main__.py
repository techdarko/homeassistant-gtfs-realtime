...
parser = argparse.ArgumentParser(
    prog="GTFS Feed Bootstrapper",
    description="Module for bootstrapping config files with the necessary setup.",
)
...
parser.add_argument("-k", "--api-key", help="API key from GTFS provider", default="")
parser.add_argument(
    "-i", "--route-icons", help="directory of route icons", default=None
)
